		...
		<div class="container text-center">
			<div class="row h-full">
				<div class="col-12 col-lg-8 offset-lg-2 align-self-center">
					<h5 class="display-4">DOSSIER PATIENT</h5> </div>
			</div>
		</div>
	</header>
	<!-- END Header -->
						                    ...
						                    if ($tabl)
						                    {
						                        ...
						                        if ($row2 > 0)
						                        {
						                            ...
						                            for ($j = 0;$j < $row2;$j++)
						                            {
						                                ...
						                                {
						?>
						<li style="margin-left: 15px;background-color: white; max-width: auto; padding: 10px 20px; border: 1px solid rgb(235,235,235); border-left: 2px solid green; list-style-type: none;">
								<a href="<?php echo $info['dirname']." / ".$info['basename'];?>" title="Download" download>
